...
<h2 style="margin-left: 30%;">Silahkan unduh laporan hanya proses</h2>
<a href="/proses-pdf" class="btn btn-primary" style="margin-top: 10px; margin-left: 125px;">Download</a><br>
<!-- <table>
    <thead>
        <th>id</th>
        <th>foto</th>
